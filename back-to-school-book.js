/* ============ FAMILY BARBERSHOP — BACK-TO-SCHOOL BOOKING (page 2 of 2) ============
   The barber-picker step of the back-to-school funnel. Page 1
   (/back-to-school) sells the offer; THIS page books it: barber cards open
   the shared profile modal (headshot + bio + real work gallery + lightbox),
   and "Book with [barber]" routes each to THEIR own book — Booksy, WhatsApp,
   or their in-shop GHL calendar. Bilingual EN/ES.
   Meta Pixel + CAPI: PageView, ViewContent (profile open), Lead (book tap,
   promo bts_20, value 20). */
...
const I18N = {
  es: {
    ...
    'sub': 'Toca un barbero para ver su trabajo y agenda directo en su propio calendario. Esa silla queda reservada para el primer día.',
...
const DYN = {
  en: { view:'View Profile', bookWith:'Book with', booksy:'On Booksy', whatsapp:'On WhatsApp', calendar:'Books Online',
        yrs:'yrs', yrsExp:'years experience', from:'From', work:'Work', recent:'recent cuts',
  ...
  es: { view:'Ver Perfil', bookWith:'Agenda con', booksy:'Por Booksy', whatsapp:'Por WhatsApp', calendar:'Agenda En Línea',
        yrs:'años', yrsExp:'años de experiencia', from:'Desde', work:'Trabajos', recent:'cortes recientes',
...
function buildProfileHTML(b){
  const dyn = DYN[LANG], fn = firstName(b.name);
  return `
    <div class="bp-top">
      <div class="bp-photo">
